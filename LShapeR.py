...
# x
# x
class LShapeR(Tetrino):
    def __init__(self, block_side, length, width):
        # positions = [Position(0, 19), Position(0, 18), Position(1, 18), Position(2, 18)]
        middle_col = length // 2 - 1
        positions = [Position(middle_col - 1, width - 1), Position(middle_col - 1, width - 2),
